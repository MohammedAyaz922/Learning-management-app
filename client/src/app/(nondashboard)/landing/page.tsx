...
// Placeholder Skeleton Component (Assume this exists in your project)
    ...
    >
      ...
      >
        ...
        <p className="landing__featured-description">
          From beginner to advanced, in all industried, we have the right
          courses just for you and preparing your entire journey for learning
          and making the most.
        </p>
        <div className="landing__tags">
           {["web development", "enterprise IT", "react", "Next JS", "Mobile development", "enterprise IT"].map((tag,index)=> (
